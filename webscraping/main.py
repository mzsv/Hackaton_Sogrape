...
# RUN ON TERMINAL: python main_all.py
# output: hackawine.db (sqlite database)
...
# 1. Continente Scraper
print('Continente Scraper...')
...
# 2. El Corte Ingles Scraper
print('El Corte Ingles Scraper...')
el_scraper = el.ElScraper(urls_el)
el_scraper.scrape()
el_scraper.save_to_sql('hackawine_table', connection_string)
print('')

# 3. Garrafeira Soares Scraper
print('Garrafeira Soares Scraper...')
